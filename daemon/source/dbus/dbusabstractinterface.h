...
typedef QVariantMap DBusPropertiesMap;
...
public:
	QDBusPendingReply<QDBusVariant> asyncProperty(const char *name) const;

	QDBusPendingReply<> asyncSetProperty(const char *name, const QVariant &value) const;

public:
	QDBusPendingReply<DBusPropertiesMap> asyncGetAllProperties() const;

	inline DBusPropertiesMap getAllProperties() const
	{
		QDBusPendingReply<DBusPropertiesMap> reply = asyncGetAllProperties();
